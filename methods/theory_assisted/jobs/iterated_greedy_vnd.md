...
- **Logs (this code state):** heuristic battery
  [`outputs/logs/instances_main_methods_20260614_114558.log`](../../../outputs/logs/instances_main_methods_20260614_114558.log)
  — self-stamped `Code state (git): 4a80e79`; paired summary + per-instance
  MILP-vs-heuristic detail in
  [`outputs/logs/gap_summary_commit5_full.txt`](../../../outputs/logs/gap_summary_commit5_full.txt)
  and
  [`outputs/logs/paired_report_commit5_full.txt`](../../../outputs/logs/paired_report_commit5_full.txt)
  (generated by `experiments/gap_summary.py` / `experiments/paired_report.py`
  from the cached MILP + fresh heuristic).
