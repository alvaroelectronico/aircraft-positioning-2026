...
> a staged fixpoint falls back to the v02 (κ-only) decode on dense
> topologies, so the method is non-regressing against both v01 (per
> (a,o)) and v02 (within noise).  Validated on the **full 360-run
> battery** (12 configs × 10 seeds × 3 profiles): **360/360 pass
> `problems/jobs/checker.py`** (0 violations), every run within the 60 s
> budget.  Part II has the 10-seed vs-MILP numbers.
...
| Methods compared  | `ta_igvnd_wMK` / `ta_igvnd_wDLY` / `ta_igvnd_wMOV` vs cached `milp_job_wMK` / `milp_job_wDLY` / `milp_job_wMOV` |
...
| --- | --- | --- | --- | --- |
| scn_chain_tight_P5_R10 | 10 | −2.26% | −7.47% | +2.68% |
| scn_full_tight_P5_R10 | 10 | +1.32% | −16.89% | +6.90% |
| scn_full_tight_P5_R20 | 10 | **+38.78%** | +16.74% | +58.66% |
| scn_hub_tight_P5_R10 | 10 | −2.13% | −5.65% | −0.02% |
| scn_none_tight_P5_R10 | 10 | +0.00% | +0.00% | +0.00% |
| scn_triangle_loose_P5_R10 | 10 | −1.54% | −4.49% | +0.25% |
| scn_triangle_medium_P5_R10 | 10 | −1.73% | −6.69% | +1.81% |
| scn_triangle_tight_P5_R10 | 10 | −0.86% | −4.29% | +1.65% |
| scn_triangle_tight_P5_R20 | 10 | **+16.57%** | +11.64% | +21.28% |
| scn_triangle_tight_P5_R30 | 10 | **+36.05%** | +26.09% | +41.91% |
| scn_triangle_tight_P5_R5 | 10 | −0.04% | −0.37% | +0.03% |
| scn_two_rows_tight_P5_R10 | 10 | −0.62% | −1.59% | +0.12% |

### wDLY (1/100/1 — delay-priority)

| Instance type | N | Mean | Min | Max |
| --- | --- | --- | --- | --- |
| scn_chain_tight_P5_R10 | 10 | −0.16% | −28.89% | +12.08% |
| scn_full_tight_P5_R10 | 10 | **+21.54%** | +2.88% | +34.10% |
| scn_full_tight_P5_R20 | 10 | **+54.88%** | +41.64% | +66.44% |
| scn_hub_tight_P5_R10 | 10 | +4.35% | −0.88% | +14.41% |
| scn_none_tight_P5_R10 | 10 | −2.52%‡ | −17.37% | +0.00% |
| scn_triangle_loose_P5_R10 | 10 | **−160.02%†** | −1043.16% | +62.78% |
| scn_triangle_medium_P5_R10 | 10 | +5.63% | −3.75% | +15.72% |
| scn_triangle_tight_P5_R10 | 10 | +4.18% | −8.66% | +12.88% |
| scn_triangle_tight_P5_R20 | 10 | **+9.45%** | −6.39% | +22.26% |
| scn_triangle_tight_P5_R30 | 10 | **+35.10%** | +17.87% | +48.67% |
| scn_triangle_tight_P5_R5 | 10 | −44.50%† | −428.26% | +2.94% |
| scn_two_rows_tight_P5_R10 | 10 | +1.11% | −5.07% | +4.94% |

### wMOV (1/1/100 — movement-priority)

| Instance type | N | Mean | Min | Max |
| --- | --- | --- | --- | --- |
| scn_chain_tight_P5_R10 | 10 | −18.51% | −29.66% | −5.97% |
| scn_full_tight_P5_R10 | 10 | +3.54% | −17.82% | +32.20% |
| scn_full_tight_P5_R20 | 10 | **+33.95%** | +21.25% | +45.98% |
| scn_hub_tight_P5_R10 | 10 | −6.53%‡ | −25.73% | +1.79% |
| scn_none_tight_P5_R10 | 10 | −2.85%‡ | −13.12% | +0.00% |
| scn_triangle_loose_P5_R10 | 10 | −7.47%‡ | −49.69% | +5.87% |
| scn_triangle_medium_P5_R10 | 10 | +2.99% | −3.40% | +8.72% |
| scn_triangle_tight_P5_R10 | 10 | −1.36% | −21.56% | +4.82% |
| scn_triangle_tight_P5_R20 | 10 | **+12.60%** | −2.63% | +20.46% |
| scn_triangle_tight_P5_R30 | 10 | **+34.28%** | +22.00% | +42.95% |
| scn_triangle_tight_P5_R5 | 10 | −29.54%† | −114.29% | +2.20% |
| scn_two_rows_tight_P5_R10 | 10 | +0.29% | −5.49% | +3.06% |

### All profiles aggregated

| Instance type | N | Mean | Min | Max |
| --- | --- | --- | --- | --- |
| scn_chain_tight_P5_R10 | 30 | −6.98% | −29.66% | +12.08% |
| scn_full_tight_P5_R10 | 30 | +8.80% | −17.82% | +34.10% |
| scn_full_tight_P5_R20 | 30 | **+42.54%** | +16.74% | +66.44% |
| scn_hub_tight_P5_R10 | 30 | −1.43% | −25.73% | +14.41% |
| scn_none_tight_P5_R10 | 30 | −1.79% | −17.37% | +0.00% |
| scn_triangle_loose_P5_R10 | 30 | −56.34%† | −1043.16% | +62.78% |
| scn_triangle_medium_P5_R10 | 30 | +2.29% | −6.69% | +15.72% |
| scn_triangle_tight_P5_R10 | 30 | +0.65% | −21.56% | +12.88% |
| scn_triangle_tight_P5_R20 | 30 | **+12.88%** | −6.39% | +22.26% |
| scn_triangle_tight_P5_R30 | 30 | **+35.14%** | +17.87% | +48.67% |
| scn_triangle_tight_P5_R5 | 30 | −24.69%† | −428.26% | +2.94% |
| scn_two_rows_tight_P5_R10 | 30 | +0.26% | −5.49% | +4.94% |

† / ‡ **small-denominator artefact — not a real loss.** On slack (`loose`),
tiny (`R5`) or no-blocking (`none`) instances the MILP optimum delay is ≈ 0,
so a few absolute units read as a huge percentage.  Cross-read the
per-component Δ tables below — they show the absolute units; never quote
these percentages alone.
...
| --- | --- | --- | --- | --- |
| scn_chain_tight_P5_R10 | 10 | +1.46 | +4.50 | −1.40 |
| scn_full_tight_P5_R10 | 10 | −1.09 | +1.95 | −9.00 |
| scn_full_tight_P5_R20 | 10 | **−115.62** | **−1080.15** | +22.80 |
| scn_hub_tight_P5_R10 | 10 | +1.51 | −7.91 | −4.00 |
| scn_none_tight_P5_R10 | 10 | +0.00 | +0.00 | +0.00 |
| scn_triangle_loose_P5_R10 | 10 | +1.06 | −2.98 | −2.00 |
| scn_triangle_medium_P5_R10 | 10 | +1.16 | −0.75 | −2.60 |
| scn_triangle_tight_P5_R10 | 10 | +0.56 | +2.44 | −1.60 |
| scn_triangle_tight_P5_R20 | 10 | **−25.58** | **−140.16** | −6.80 |
| scn_triangle_tight_P5_R30 | 10 | **−123.20** | **−1497.10** | −2.60 |
| scn_triangle_tight_P5_R5 | 10 | +0.00 | +1.15 | +0.00 |
| scn_two_rows_tight_P5_R10 | 10 | +0.46 | −5.70 | −1.60 |

### wDLY (1/100/1)

| Instance type | N | Δmakespan | Δdelay | Δmov |
| --- | --- | --- | --- | --- |
| scn_chain_tight_P5_R10 | 10 | −1.49 | −0.55 | −2.40 |
| scn_full_tight_P5_R10 | 10 | −16.59 | −44.60 | +7.00 |
| scn_full_tight_P5_R20 | 10 | **−159.13** | **−1301.92** | +10.80 |
| scn_hub_tight_P5_R10 | 10 | −4.34 | −5.30 | +0.20 |
| scn_none_tight_P5_R10 | 10 | +1.90 | +2.50 | +0.00 |
| scn_triangle_loose_P5_R10 | 10 | +2.11 | +1.07 | +0.80 |
| scn_triangle_medium_P5_R10 | 10 | −0.99 | −3.20 | −3.60 |
| scn_triangle_tight_P5_R10 | 10 | −3.19 | −4.70 | −7.20 |
| scn_triangle_tight_P5_R20 | 10 | −15.24 | −82.05 | −6.20 |
| scn_triangle_tight_P5_R30 | 10 | **−118.45** | **−1212.05** | −6.80 |
| scn_triangle_tight_P5_R5 | 10 | +0.00 | +0.20 | +0.20 |
| scn_two_rows_tight_P5_R10 | 10 | −2.19 | −1.20 | −2.40 |

### wMOV (1/1/100)

| Instance type | N | Δmakespan | Δdelay | Δmov |
| --- | --- | --- | --- | --- |
| scn_chain_tight_P5_R10 | 10 | +15.57 | +28.02 | +0.00 |
| scn_full_tight_P5_R10 | 10 | +7.36 | −17.29 | +0.00 |
| scn_full_tight_P5_R20 | 10 | **−71.52** | **−496.21** | +0.00 |
| scn_hub_tight_P5_R10 | 10 | +4.96 | +7.30 | +0.00 |
| scn_none_tight_P5_R10 | 10 | +2.00 | +2.50 | +0.00 |
| scn_triangle_loose_P5_R10 | 10 | +2.91 | +1.98 | +0.00 |
| scn_triangle_medium_P5_R10 | 10 | −0.14 | −3.65 | +0.00 |
| scn_triangle_tight_P5_R10 | 10 | +1.16 | +0.80 | +0.00 |
| scn_triangle_tight_P5_R20 | 10 | −19.52 | −102.39 | +0.00 |
| scn_triangle_tight_P5_R30 | 10 | **−123.71** | **−1126.66** | +0.00 |
| scn_triangle_tight_P5_R5 | 10 | +3.10 | +6.90 | +0.00 |
| scn_two_rows_tight_P5_R10 | 10 | +0.81 | −1.50 | +0.00 |

## Performance summary

**Large instances (R20/R30) — dominant across all three profiles.**
`full_R20` mean gap is **+38.8 % wMK / +54.9 % wDLY / +34.0 % wMOV** —
the heuristic returns far better feasible schedules in the same 60 s
budget while the MILP is 80–99 % from converged.  Same story on
`triangle_R20` (**+16.6 / +9.5 / +12.6 %**) and `triangle_R30`
(**+36.1 / +35.1 / +34.3 %**), with the absolute Δ tables showing
makespan wins of 100+ units and delay wins of 1000+ units —
substantial, not small-denominator artefacts.

**R10 tight — competitive across the board.**  Most rows are within
±5 % of the MILP.  The wDLY profile slightly favours the heuristic
on `full_R10` (+21.5 %, Δdelay −44.6) and on the triangle variants
(+4–6 %); wMK is mostly flat (within ±2 %).  The R10 wMOV column
shows small negatives on `chain` (−18.5 %, Δmakespan +15.6,
Δdelay +28.0 at zero movements — the genuine remaining gap: the
MILP packs the 0-movement schedule tighter than the heuristic does)
and on `triangle_R10` (−1.4 %, small absolute).

**wMOV stays at zero movements.**  Δmov ≡ 0 on every R10 type and
on the two R20/R30 type.  The dispatcher prefers the zero-movement
decode under wMOV (W^S = 100 dominates), so the heuristic neither
gains nor loses movement count vs the MILP; the comparison reduces
to which side packs the 0-movement schedule tighter.

**Negative percentages on `loose`, `R5`, `none` are small-denominator,
not real losses.**  triangle_loose wDLY = −160.0 % but the per-component
Δdelay is +1.07; triangle_R5 wDLY = −44.5 % but Δdelay is +0.2;
`none` columns are noise.  Confirmed by the absolute Δ tables.

## Caveats

1. **Small-denominator inflation.** When the MILP optimum delay is ≈ 0
   (slack `loose`, tiny `R5`, no-blocking `none`, or 0-movement
   profiles), a few absolute units read as a huge percentage — e.g.
   triangle_loose wDLY shows −160 % but is only +1.1 delay units.
   Cross-read the per-component Δ tables; never quote these percentages
   alone.  Marked † / ‡ in the gap tables above.
2. **MILP unconverged at scale.** On R20 / R30 the MILP's 60 s objective
   has an 80–99 % optimality gap, so the large wins mean "better
   feasible solution in the same budget", not proven optimality.
3. **Run-to-run noise.** The heuristic is time-limited and
   non-deterministic at the 60 s cut; the noise floor on this battery
   is ~19 delay units, so deltas smaller than that (and the ±-flips
   in the min/max columns of small-denominator rows) are noise.
4. **Staged fixpoint cost.** On dense topologies the joint (κ, gaps)
   fixpoint oscillates (~37 % non-convergence on `full_R10`) and bails
   to the κ-only path; this costs extra forward passes, so search depth
   on dense instances is shallower than v02 even though quality matches.
   Incremental re-classification (Part III) is the fix.
...
| (main) | v05: incremental zero decode in the VND — a phase-A move re-places only `order[k:]` from the cached prefix (`_zero_place`/`_zero_obj_inc`), exact vs the full zero decode (1701 probes, 0 mismatches) | **+14–17 % more iterations** (R30/R20).  Full 10-seed battery (360/360 COMPLIANT): **statistically unchanged vs v03.1** (deltas ±0.1–1.7 pt) — the search is **quality-saturated at 60 s**, so throughput no longer moves quality.  Merged as a correct, regression-free speedup.  (An adaptive Mode-B-skip attempt was tried first and reverted — it killed valuable Mode-B on full_R20 wMK, +37 %.) |
