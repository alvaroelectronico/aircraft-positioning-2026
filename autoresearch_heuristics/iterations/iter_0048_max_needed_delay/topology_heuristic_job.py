...
def _resolve_rear_interactions(
    ...
    # Each iteration computes the MAX needed delay across all overlapping
    # fronts and shifts once — avoids the accumulating-delay over-shoot
