...
\end{align}
Equation~\eqref{eq:ps_assign} enforces that every aircraft is assigned to
exactly one position; \eqref{eq:ps_chain} chains each aircraft's jobs in
the prescribed order; \eqref{eq:ps_earlystart} respects the earliest
