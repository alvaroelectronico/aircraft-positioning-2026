...
while the safe pipeline takes over as the fleet size grows: in our
benchmark the exact solver is optimal only at $R = 5$ and is already
dominated by the heuristics at $R = 10$ under a 60-second wall-clock
budget, placing the crossover between $5$ and $10$ aircraft --- earlier
than the $14$--$25$-aircraft threshold reported across the hangar
literature for exact MILP optimality \citep{Pazhooh2025, Guepet2015,
Shaukat2020, Qin2019}, as expected for our deliberately congested
benchmark layouts.  Rather than competing directly with
