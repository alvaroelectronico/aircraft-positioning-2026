...
$17$--$34\,\%$ over \textbf{MILP} on Chain, Hub, Triangle, Two rows and
...
\emph{Full $R{=}10$} and \emph{Triangle $R{=}20$}, $\bar n{=}2.0$ on
\emph{Triangle $R{=}30$} and $\bar n{=}2.6$ on the dense
\emph{Full $R{=}20$} --- at the cost of a
