...
The user wants `methods/theory_assisted/jobs/iterated_greedy_vnd.md` to
always document what the heuristic does and stay in sync with
...
Design rationale belongs in [[design.md]] / `notes/design.md`; the `.md`
describes current behaviour, contract, and config.
