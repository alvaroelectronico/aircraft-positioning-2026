...
We report mean values over the six random seeds available for each
configuration at the time of writing (the full ten-seed run is in progress).  The
analysis is organised around four questions: (i) up to what size is the MILP
...
$100\,\%$; moreover, on five of the six seeds Gurobi aborts before
returning any feasible incumbent (for both Triangle and Full $R{=}20$),
so each $R{=}20$ MILP row aggregates a single usable run.  At $R{=}30$
...
are practically tied ($107.2$ versus $109.3$).  Within a 60\,s budget
...
returns $\bar f = 677$ against \textbf{MILP}'s $2425$, and on
\emph{Full $R{=}20$} the gap is $963$ versus $4676$, both more than
...
non-trivial blocking: from $24\,\%$ on \emph{Triangle $R{=}10$} up to
$40\,\%$ on \emph{Hub $R{=}10$} and $79\,\%$ on \emph{Full $R{=}10$},
and dramatic gaps on the larger instances ($282\,\%$ on
...
attains $0\,\%$ throughout.  Two apparent outliers stand out: every
method sits at $41.6\,\%$ on \emph{Triangle $R{=}10$, loose}, and at
$5.2\,\%$ on \emph{Triangle $R{=}5$} (Topo/FAS/Safe).  Both come from
...
$\bar n{=}1.0$ on \emph{Chain $R{=}10$}, $\bar n{=}0.3$ on
\emph{Full $R{=}10$}, $\bar n{=}1.7$ on \emph{Triangle $R{=}30$} and
$\bar n{=}2.0$ on the dense \emph{Full $R{=}20$} --- at the cost of a
moderate makespan penalty: e.g.\ $\bar m{=}86.3$ on
\emph{Full $R{=}10$} versus $62.4$ under wC, and $\bar m{=}170.3$ on
\emph{Full $R{=}20$} versus $119.8$.  Switching to the delay-priority
profile (wB) collapses the mean delay onto a narrow band ---
$\bar v^D \approx 100.7$ on every $R{=}10$ tight row regardless of
topology --- but injects $6$--$45$ blocking movements per instance.
The makespan-priority profile (wC) flattens $\bar m$ to about
$62.3$--$62.4$ on every $R{=}10$ tight row at the price of
$3$--$28$ movements and intermediate delay.  The three profiles
