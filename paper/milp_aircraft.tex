...
finish times of aircraft $r$ at its assigned position.  The binary
variables are $x_{rp}$ (1 if aircraft $r$ is assigned to position $p$)
and $q_{rr'p}$ (1 if aircraft $r$ precedes aircraft $r'$ at position
$p$).
